      ...
      <div className="Landing">
        ...
        <div className="Landing__container">
          <div className="Landing__container__whatsSavit">
            ...
            <div className="Landing__container__whatsSavit__text">
              <h3>¿Qué es Savit?</h3>
              <p>
                ...
                animales, las cuales pueden registrar y gestionar las mascotas
                que actualemente necesitan un hogar.
                <br />
                <br />
                ...
                protectoras de animales un espacio propio y de diseño agradable, donde se viese de
                forma sencilla las diferentes mascotas que estaban bajo su
                cuidado, de forma complementaria a las diferentes redes
                sociales, tan necesarias hoy en día para obtener visibilidad.
              </p>
            </div>
              <div className="Landing__container__whatsSavit__techs">
                <p>El desarrollo de esta web-app se ha realizado usando MERN Stack
                y SaSS.</p>
              </div>
          </div>
          ...
          <div className="Landing__container__howWorks">
            ...
            <div className="Landing__container__howWorks__text">
              <h3>¿Cómo se usa Savit?</h3>
              <p>
                Registrarse, y hará login automáticamente.
                <br />
                La navegación será fundamentalmente mediante las pestañas Mascotas y Asociaciones
              </p>
            </div>
            <div className="Landing__container__howWorks__text__list">
              <h5>Mascotas:</h5>
              <ul>
                <li>Ver todas las mascotas existentes en la aplicación.</li>
                <li>
                  Al hacer click en una en concreto, veremos su lista completa
                  de detalles, y un botón el cual nos llevará al perfil de la
